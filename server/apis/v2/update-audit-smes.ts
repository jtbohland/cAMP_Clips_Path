...
const SME_UPDATES: Array<{ topicKey: string; title?: string; smes: Array<{ name: string; title: string; note?: string }> }> = [
  ...
  { topicKey: "day3_gtm_pod", smes: [{ name: "Matt Kahan", title: "Senior Director, Revenue Operations" }, { name: "Simon Levinson", title: "VP, Revenue Operations" }] },
  ...
  { topicKey: "day7_account_planning", smes: [{ name: "Simon Levinson", title: "VP, Revenue Operations" }] },
  { topicKey: "day8_discovery", smes: [{ name: "JT Bohland", title: "GTM Enablement Lead" }] },
  { topicKey: "day9_pricing", smes: [{ name: "Megha Sisaudia", title: "Head of Pricing Strategy & Operations", note: "on leave" }, { name: "Katie Helie", title: "VP of Finance" }] },
  ...
  { topicKey: "day11_forecasting", title: "Forecasting, including Services", smes: [{ name: "Corey Gibbel", title: "VP, Revenue Operations" }, { name: "Ganit Bar-Dor", title: "VP, Professional Services" }] },
  ...
  { topicKey: "day14_deal_desk", smes: [{ name: "Matt Murray", title: "VP, Revenue Operations" }, { name: "Katie Helie", title: "VP of Finance" }, { name: "Megha Sisaudia", title: "Head of Pricing Strategy & Operations", note: "on leave" }] },
