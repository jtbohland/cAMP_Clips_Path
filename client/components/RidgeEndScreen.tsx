...
export default function RidgeEndScreen({
  netXp,
  badge,
  totalXp,
  correctCount,
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-5">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 text-center">
        ...
        <p className="text-xs text-gray-500 mb-4">Rules of the Ridge Badge</p>
      ...
      {/* New total XP (only for real games) */}
      {!isReplay && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 text-center">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <h3 className="text-sm font-bold text-gray-700 mb-3">ROE Section Breakdown</h3>
      ...
      <p className="text-center text-xs text-gray-400 italic">
        No stakes. No wagers. Just 10 fresh scenarios from 50+ in the vault.
      </p>
    </div>
  );
}
