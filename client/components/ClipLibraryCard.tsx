...
// ── Sort order constants (updated after Phase 1 migration — ×10 spacing) ──
// Topic days: sort_order 60 (Renewal Ops), 120 (Pricing & Packaging)
...
const DEAL_DESK_SORT_ORDER = 180;
